    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('KPK', 'KPK'), ('Balochistan', 'Balochistan'), ('Sindh', 'Sindh'), ('Punjab', 'Punjab'), ('Gilgit', 'Gilgit'), ('Kashmir', 'Kashmir'), ('Islamabad', 'Islamabad'), ('FATA', 'Haryana')], max_length=50)),
